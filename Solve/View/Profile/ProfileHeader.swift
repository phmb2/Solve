...
class ProfileHeader: UICollectionReusableView {
    ...
    private func configureUI() {
        ...
        editProfileFollowButton.setTitle(profileHeaderViewModel.actionButtonTitle, for: .normal)
        
        fullnameLabel.text = user.fullname
        usernameLabel.text = profileHeaderViewModel.usernameText
        
        followingLabel.attributedText = profileHeaderViewModel.followingText
        followersLabel.attributedText = profileHeaderViewModel.followersText
    }
}
